...
class HelpPage(Page):
    ...
    HEADER_SUPPORT = (By.XPATH, "//h1[text()=' Mobile & app support']")
    ...
    def verify_promotions(self):
        self.wait_for_element_appear(*self.HEADER_SUPPORT)

    def verify_support_url(self):
        self.verify_url('https://help.target.com/help/SubCategoryArticle?childcat=Mobile+%26+app+support&parentcat'
                        '=Technical+Support&searchQuery=')
